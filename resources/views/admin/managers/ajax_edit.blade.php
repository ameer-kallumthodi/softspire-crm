<form id="managerEditForm" method="POST" action="{{ route('admin.managers.update', $user->id) }}">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col-md-6">
...
$(document).ready(function() {
    $('#managerEditForm').on('submit', function(e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    showToast(response.message || 'Manager updated successfully', 'success');
            ...
            error: function(xhr) {
                let errorMessage = 'Error updating manager';
                if (xhr.responseJSON) {
