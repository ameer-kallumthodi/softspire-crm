    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('admin.lead-statuses.update', $leadStatus) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $leadStatus->name) }}" required>
                                @error('name')
                    ...
                    <div class="mt-4">
                        ...
                        <a href="{{ route('admin.lead-statuses.index') }}" class="btn btn-secondary">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
