                ...
                <form action="{{ route('admin.leads.update', $lead) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="country_code" class="form-control @error('country_code') is-invalid @enderror" value="{{ old('country_code', $lead->country_code) }}" required>
                                @error('country_code')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <select name="purpose_id" class="form-control @error('purpose_id') is-invalid @enderror" required>
                                    ...
                                    <option value="{{ $purpose->id }}" {{ old('purpose_id', $lead->purpose_id) == $purpose->id ? 'selected' : '' }}>{{ $purpose->name }}</option>
                                    @endforeach
                                </select>
                                @error('purpose_id')
                                <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="date" name="date" class="form-control @error('date') is-invalid @enderror" value="{{ old('date', $lead->date->format('Y-m-d')) }}" required>
                                @error('date')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="date" name="followup_date" class="form-control @error('followup_date') is-invalid @enderror" value="{{ old('followup_date', $lead->followup_date ? $lead->followup_date->format('Y-m-d') : '') }}">
                                @error('followup_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                <label>Is Meta</label>
                                <input type="checkbox" name="is_meta" value="1" {{ old('is_meta', $lead->is_meta) ? 'checked' : '' }}>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                <label>Is Converted</label>
                                <input type="checkbox" name="is_converted" value="1" {{ old('is_converted', $lead->is_converted) ? 'checked' : '' }}>
                            </div>
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        <label>Remarks</label>
                        <textarea name="remarks" class="form-control @error('remarks') is-invalid @enderror" rows="3">{{ old('remarks', $lead->remarks) }}</textarea>
                        @error('remarks')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
